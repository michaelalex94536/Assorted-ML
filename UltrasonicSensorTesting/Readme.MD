...
Successful operation of the range sensor requires, of course, robust detection of the Rx signal.  In addition to the distance between the sensor and the target, the amplitude of the Rx signal is a function of the strength of the Tx signal.  In addition, the device operating frequency and other characteristics of the device also determine the intensity of the Rx signal.  
